...
-- -----------------------------------------------------
-- Table `csgmapper`.`states`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `csgmapper`.`states` ;

CREATE TABLE IF NOT EXISTS `csgmapper`.`states` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `name` VARCHAR(45) NOT NULL COMMENT '',
  PRIMARY KEY (`id`)  COMMENT '',
...
-- -----------------------------------------------------
-- Table `csgmapper`.`results`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `csgmapper`.`results` ;

CREATE TABLE IF NOT EXISTS `csgmapper`.`results` (
  ...
  CONSTRAINT `fk_results_2`
    ...
    REFERENCES `csgmapper`.`states` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `csgmapper`.`steps`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `csgmapper`.`steps` ;

CREATE TABLE IF NOT EXISTS `csgmapper`.`steps` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '',
...
CREATE TABLE IF NOT EXISTS `csgmapper`.`jobs` (
  ...
  CONSTRAINT `fk_jobs_1`
    ...
    REFERENCES `csgmapper`.`results` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_jobs_2`
    FOREIGN KEY (`step_id`)
    REFERENCES `csgmapper`.`steps` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
